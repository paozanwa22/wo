  ...
  <body class="bg-light">
    ...
    <main role="main" class="container">
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          <h6 class="mb-0 text-white lh-100">ABOUT</h6>
          <small>Wedding</small>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <div class="media text-muted pt-3">
          ...
          <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <strong class="d-block text-gray-dark">@facebook</strong>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Rias</strong>
              <a href="#">Follow</a>
            </div>
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Wedding / Dekor</strong>
              <a href="#">Follow</a>
            </div>
            <span class="d-block">@username</span>
          </div>
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">fotografer</strong>
              <a href="#">Follow</a>
            </div>
            <span class="d-block">@username</span>
          </div>
        ...
        <div class="row">
          ...
          <small class="d-block text-right mt-3 mb-5 col-4">
            <img src="../img/googlemaps.jpeg" width="80px" alt="" class="mr-2 rounded">            
            <p>Google Map</p>
            <h7>Jln.Mataram Lorem ipsum dolor sit, amet consectetur adipisicing.</h7>
          </small>
