        ...
        <div class="col-md-8 order-md-1">
          ...
          <form action="" method="POST" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <input autocomplete="off" type="email" class="form-control" id="email" placeholder="you@example.com">
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input autocomplete="off" type="text" class="form-control" id="address" placeholder="1234 Main St" required>
              <div class="invalid-feedback">
